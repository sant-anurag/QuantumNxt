...
class ResumeParser:
    ...
    def extract_name(self, text):
        ...
        lines = [l for l in lines if not re.search(r'resume|curriculum|profile|cv|contact', l, re.I)]
        for l in lines[:15]:
            doc = self.nlp(l)
            if any(ent.label_ == "PERSON" for ent in doc.ents) and len(l.split()) <= 4:
                return l
