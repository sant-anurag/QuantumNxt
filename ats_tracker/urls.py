...
urlpatterns = [
    ...
    path('teams/manage_members/', views.manage_members, name='manage_members'),
    path('api/manage_members/change-member-status/', views.change_member_status, name='change_member_status'),
    ...
    path('access_permissions/change_active_status/<int:user_id>/<str:action>/', views.change_user_status, name='change_user_status'),
