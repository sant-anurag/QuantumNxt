...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-0*h-5z%er%q!7j00p$2f953cm8+m)m_&4&xux7np*$lr69@%d5')
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'ats_tracker', 'static'),
]
# Templates
TEMPLATES[0]['DIRS'] = [
    os.path.join(BASE_DIR, 'ats_tracker', 'templates'),
]
